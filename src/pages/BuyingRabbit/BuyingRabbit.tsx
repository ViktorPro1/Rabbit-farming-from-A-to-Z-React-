...
const BuyingRabbit = () => {
  ...
  return (
    <PageLayout
      className="buy-page"
      title="🐇 Купівля кроля: від А до Я"
      subtitle="Де купувати, на що дивитись при огляді, червоні прапорці"
      shareTitle="Поділитись"
      relatedLinks={[
        { to: "/beginner-guide", icon: "🚀", label: "Маршрут новачка" },
        { to: "/biosecurity", icon: "🛡️", label: "Біобезпека та карантин" },
        { to: "/symptoms", icon: "🌡️", label: "Симптоматичний пошук" },
        { to: "/sexing", icon: "🔎", label: "Визначення статі" },
        {
    ...
    >
            ...
            <div className="buy-source-body">
              <div className="buy-source-row">
                ...
                <p>
                  ...
                  репутації — відповідає на питання і після продажу. Тварини, як
                  правило, добре соціалізовані. Можливість побачити батьківське
                  поголів'я — оцінити темперамент та стан здоров'я лінії.
                  Відповідальний заводчик не продає до 8 тижнів.
                </p>
              </div>
              <div className="buy-source-row">
          ...
          <div className="buy-source-card ok">
            ...
            <div className="buy-source-body">
              <div className="buy-source-row">
                <span className="buy-source-label">Переваги:</span>
                <p>
                  Часто нижча ціна. Можуть продавати з реальних причин (переїзд,
                  алергія) тварину, за якою добре доглядали.
                </p>
              </div>
              <div className="buy-source-row">
                <span className="buy-source-label">Ризики:</span>
            ...
            <div className="buy-source-body">
              <div className="buy-source-row danger-row">
                ...
                <p>
                  ...
                  даними ветеринарної практики — покупки на ринку є найчастішою
                  причиною спалахів кокцидіозу, пастерельозу та ВГХК у нових
                  власників. Вік зазвичай невідомий або занижений. Жодних
                  гарантій, жодної відповідальності продавця.
                </p>
              </div>
              <div className="buy-source-row danger-row">
                ...
                <p>
                  Суворий карантин мінімум 14 днів. Ветогляд у перші 24 години.
                  Аналіз посліду на кокцидіоз. Не підселяти до наявного
                  поголів'я до завершення карантину.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="buy-content">
          ...
          <div className="buy-cards-grid">
            <div className="buy-card">
              ...
              <p>
                Яєчка стають помітними з 10–12 тижнів, але самець може втягувати
                їх у черевну порожнину при стресі — ненадійна ознака (Merck
                Veterinary Manual). Для визначення статі у молодняку необхідний
                досвід або допомога ветеринара. Помилки при визначенні статі на
                ринку — вкрай часті.
              </p>
            </div>
            <div className="buy-card">
            ...
            <div className="buy-card">
              ...
              <p>
                RWAF рекомендує тримати кролів парами — вони соціальні тварини.
                Найстабільніша пара: кастрований самець + самка. Якщо купуєте
                двох молодих — обов'язково каструвати обох якомога швидше, до
                появи агресії.
              </p>
            </div>
      ...
      {activeTab === "health" && (
        <div className="buy-content">
          <p className="buy-intro">
            ...
            обстановці, не поспішаючи. Нижче — систематичний огляд за системами,
            підтверджений Merck Veterinary Manual, RSPCA та Best Friends Animal
            Society.
          </p>
          ...
          <div className="buy-check-list">
            ...
            <div className="buy-check-item">
              ...
              <div className="buy-check-body">
                <div className="buy-check-good">
                  <span>✓</span>
                  <span>
                    Верхні різці злегка перекривають нижні (легкий прикус). Зуби
                    рівні, без надмірного росту
                  </span>
                </div>
                <div className="buy-check-bad">
                  <span>✗</span>
                  <span>
                    ...
                    найпоширеніша спадкова хвороба кролів за Merck). Слинотеча,
                    вологе підборіддя — ознака зубних проблем. Набряк щоки —
                    можлива ознака абсцесу
                  </span>
                </div>
              </div>
            </div>
            ...
            <div className="buy-check-item">
              ...
              <div className="buy-check-body">
                <div className="buy-check-good">
                  <span>✓</span>
                  <span>
                    М'язисте, пружне тіло. Ребра промацуються, але не випирають.
                    Добре розвинений крижовий відділ
                  </span>
                </div>
                <div className="buy-check-bad">
                  <span>✗</span>
              ...
              <div className="buy-check-body">
                ...
                <div className="buy-check-bad">
                  ...
                  <span>
                    ...
                    перистальтикою. Сечові плями на шерсті — можлива неврологія
                    або інфекція сечовивідних шляхів. Ризик міазу при будь-якому
                    забрудненні
                  </span>
                </div>
              </div>
            ...
            <div className="buy-check-item">
              <div className="buy-check-head">
                <span className="buy-check-icon">🧠</span>
                <span className="buy-check-title">Поведінка та активність</span>
              </div>
              <div className="buy-check-body">
                <div className="buy-check-good">
                  <span>✓</span>
      ...
      {activeTab === "redflags" && (
        <div className="buy-content">
          <p className="buy-intro">
            Деякі ознаки вимагають негайної відмови від купівлі — незалежно від
            ціни, тиску продавця або вже витраченого шляху. Нижче — повний
          ...
          <div className="buy-flags-list">
            ...
            <div className="buy-flag red">
              <span className="buy-flag-icon">🔴</span>
              <div>
                <span className="buy-flag-title">Забруднена задня частина</span>
                <p>
            ...
            <div className="buy-flag red">
              ...
              <div>
                ...
                <p>
                  Merck: горбата поза є класичною ознакою болю у кроля. Тварина,
                  що не реагує на подразники — серйозно хвора.
                </p>
              </div>
            </div>
            <div className="buy-flag red">
            ...
            <div className="buy-flag red">
              ...
              <div>
                ...
                <p>
                  AVMA: якщо хтось з виводку виглядає хворим — не купуйте навіть
                  здорового на вигляд однопомітника: він, ймовірно, вже
                  інфікований.
                </p>
              </div>
            </div>
            <div className="buy-flag red">
              ...
              <div>
                ...
                <p>
                  Занадто рання купівля — провідна причина загибелі молодняку в
                  перші 2 тижні після придбання. Ніякі обіцянки продавця не
                  змінюють біологію.
                </p>
              </div>
            </div>
            <div className="buy-flag red">
              ...
              <div>
                ...
                <p>
                  Ознака отиту, E. cuniculi або вестибулярного синдрому. Складне
                  і тривале лікування, часто неповне відновлення.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="buy-flags-list">
            ...
            <div className="buy-flag orange">
              ...
              <div>
                ...
                <p>
                  При купівлі у заводчика — ви маєте право бачити хоча б матір.
                  Відмова — підозрілий сигнал.
                </p>
              </div>
            </div>
            <div className="buy-flag orange">
              ...
              <div>
                ...
                <p>
                  Ознака «розплідника-фабрики» або перекупника — у таких місцях
                  тварини рідко отримують належний догляд і ветеринарний
                  контроль.
                </p>
              </div>
            </div>
          ...
          <div className="buy-qa-list">
            <div className="buy-qa-item">
              ...
              <div className="buy-qa-answer bad">
                <span>✗ Погана відповідь:</span> «Приблизно», «десь 1,5 місяця»,
                «вже їсть самостійно».
              </div>
            </div>
            ...
            <div className="buy-qa-item">
              ...
              <div className="buy-qa-answer bad">
                ...
                овочі», «змішаний корм з магазину» — ознака відсутності базових
                знань.
              </div>
            </div>
            ...
            <div className="buy-qa-item">
              ...
              <div className="buy-qa-answer good">
                <span>✓ Хороша відповідь:</span> Ветеринарний паспорт або картка
                з підписом лікаря, навіть якщо тільки первинний огляд.
              </div>
              <div className="buy-qa-answer bad">
            ...
            <div className="buy-qa-item">
              <div className="buy-qa-question">
                Можу я зв'язатись з вами після купівлі, якщо виникнуть питання?
              </div>
              <div className="buy-qa-answer good">
          ...
          <div className="buy-cards-grid">
            ...
            <div className="buy-card">
              ...
              <p>
                ...
                сигнал: такий заводчик не знає базових потреб кролів, і тварини,
                ймовірно, мають зубні та травні проблеми.
              </p>
            </div>
            <div className="buy-card">
              <div className="buy-card-header">
          ...
          <div className="buy-steps">
            <div className="buy-step">
              ...
              <div>
                ...
                <p>
                  Якщо у вас вже є кролі — новий кролик не повинен мати жодного
                  контакту з ними мінімум 2 тижні. Окреме приміщення або клітка
                  з відстанню від інших. Окремий інвентар, мийте руки між
                  доглядом.
                </p>
              </div>
            </div>
            <div className="buy-step">
              ...
              <div>
                ...
                <p>
                  ...
                  перші 48–72 години. Перевірка зубів, загальна кондиція, аналіз
                  посліду при підозрі на кокцидіоз. Навіть якщо кролик виглядає
                  здоровим — огляд обов'язковий.
                </p>
              </div>
            </div>
            <div className="buy-step">
            ...
            <div className="buy-step">
              ...
              <div>
                ...
                <p>
                  ...
                  кролик звикне до запахів і звуків нового середовища у власному
                  темпі.
                </p>
              </div>
            </div>
            <div className="buy-step">
              ...
              <div>
                ...
                <p>
                  ...
                  стан носа та очей. Зважте при купівлі — зважуйте раз на 3 дні.
                  Втрата більше 5% ваги за тиждень — ветеринар.
                </p>
              </div>
            </div>
            <div className="buy-step">
