...
const helpItems = [
  ...
  },
  {
    icon: "📅",
    title: "Календар",
    desc: "Календар з усіма контрольними датами. Відображає окроли, відлучки, ревакцинації та дезінфекції. Можна перемикати між місяцями і переглядати деталі по кожній події.",
  },
  {
    icon: "🔒",
    title: "Карантин",
  ...
  },
  {
    icon: "🧰",
    title: "Аптечка",
    desc: "Облік ветпрепаратів. Витрати категорії «Ветеринарія» з Фінансів потрапляють сюди автоматично — залишається вказати кількість і термін придатності. Показує залишок кожного препарату і попереджає про прострочення.",
  },
  {
    icon: "⚖️",
    title: "Зважування",
  ...
  },
  {
    icon: "💰",
    title: "Фінанси",
    desc: "Фінансовий облік господарства. Додавай витрати і отримуй дохід автоматично з продажів у Відгодівлі.",
  },
  {
    icon: "🏷️",
    title: "Собівартість",
    desc: "Аналіз собівартості. Дані беруться з Фінансів, Відгодівлі та Зважування автоматично, вводити нічого вдруге не потрібно. Для кожної партії відгодівлі показує витрати на корм, препарати та вакцинацію, собівартість одного кроля та 1 кг ваги; окремо показує накопичені витрати по кожному кролю з реєстру. Розрахунок орієнтовний: витрати розподіляються пропорційно кількості голів і діб.",
  },
  {
    icon: "📉",
    title: "Статистика",
  ...
  },
  {
    ...
    desc: "Пошук за номером клітки автоматично показує повну історію та всі події, пов’язані з нею.",
  },
  {
    icon: "📦",
    title: "Архів",
  ...
  },
  {
    ...
    desc: "Генерація QR-коду для кожної клітки. Роздрукуй і прикріпи на клітку — при скануванні відкривається історія та всі події цієї клітки.",
  },
  {
    icon: "📄",
    title: "Експорт CSV",
  ...
  },
  {
    ...
    desc: "Нагадування про вакцинації, окроли та інші події кабінету — прямо в браузер, навіть коли сайт закритий. Вмикається в Налаштуваннях: натисни на своє ім'я/назву господарства у шапці (з іконкою ⚙️) і обери «Дозволити сповіщення».",
  },
];
    ...
    <div className="registry-page">
      ...
      <div className="registry-header">
        <div className="registry-header-top">
          ...
          >
            {currentLabel}
            <span className="registry-settings-gear" aria-hidden="true">
              ⚙️
            </span>
          </button>
        </div>
        ...
        <button
          className="registry-nav-toggle"
          onClick={() => setShowNav(!showNav)}
        >
          📊 Панель кролівництва
          <span className={`registry-nav-arrow ${showNav ? "open" : ""}`}>
            ▼
          </span>
        </button>
          ...
          <div className="registry-header-nav">
            ...
            <div className="nav-section">
              ...
              <div className="nav-section-grid">
                ...
                {/* Додано: перехід на сторінку «Аналіз собівартості» */}
                <button
                  className="registry-archive-link"
