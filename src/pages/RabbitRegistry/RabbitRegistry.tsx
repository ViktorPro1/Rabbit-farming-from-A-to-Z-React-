...
const helpItems = [
  ...
  },
  {
    ...
    desc: "Нагадування про контрольні дати. Система відправляє сповіщення на телефон або комп'ютер, коли наближається дата окролу, відлучки, ревакцинації чи повторної дезінфекції.",
  },
  {
    icon: "📅",
    title: "Календар",
