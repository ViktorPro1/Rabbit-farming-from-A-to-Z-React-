...
const relatedLinks = [
  { to: "/diseases", icon: "🩺", label: "Хвороби" },
  { to: "/water-medication", icon: "💧", label: "Пропойка" },
  { to: "/zoonoses", icon: "🦠", label: "Зоонози" },
  { to: "/biosecurity", icon: "🛡️", label: "Біобезпека та карантин" },
  { to: "/dosage-calculator", icon: "🧮", label: "Калькулятор дозування" },
];
...
const Parasites = () => {
  return (
    <PageLayout
      className="parasites-page"
      title="Паразити кроликів"
      subtitle="Зовнішні та внутрішні паразити — симптоми, лікування та профілактика"
      shareTitle="Паразити кроликів"
      ...
      <div className="parasites-grid">
        <article className="parasites-card">
          ...
          <div className="parasites-card-body">
            ...
            <ul>
              ...
              <li>Коричневі або жовтуваті кірки та виділення всередині вуха</li>
              <li>
                При занедбаності — нахил голови, порушення рівноваги (отит)
              </li>
            </ul>
            <p>
              <strong>Діагностика:</strong> огляд вуха — кірки видно неозброєним
              оком. Точно — зіскрібок під мікроскопом.
            </p>
            <p>
            ...
            <ul>
              ...
              <li>
                <strong>Акарицидні краплі у вухо</strong> (Отодектин, Амітразин
                плюс) — безпосередньо в слуховий прохід.
              </li>
              <li>
                Кірки не видаляти насильно — вони відпадуть самі після загибелі
                кліщів.
              </li>
            </ul>
            <p>
        ...
        <article className="parasites-card">
          ...
          <div className="parasites-card-body">
            ...
            <ul>
              <li>
                Лупа — білясті лусочки шкіри, особливо в ділянці холки та спини
              </li>
            ...
            <ul>
              <li>
                Обробка клітки та інвентарю розчином деревної золи або відваром
                полину — засіб для дезінфекції середовища, а не для лікування
                самої тварини
              </li>
              <li>
                Купання у слабкому дьогтьовому милі допомагає прибрати лусочки й
                трохи полегшує свербіж
              </li>
            </ul>
            <div className="parasites-alert warn">
        ...
        <article className="parasites-card">
          ...
          <div className="parasites-card-body">
            ...
            <p>
              <strong>Збудники:</strong> Haemodipsus ventricosus (справжня вош),
              Listrophorus gibbus (хутровий власоїд — не кровосисний).
            </p>
            <p>
              <strong>Симптоми:</strong>
            </p>
            ...
            <ul>
              ...
              <li>Обов'язкова дезінфекція клітки — яйця стійкі в середовищі</li>
            </ul>
            <p>
              <strong>Народні методи (допоміжно):</strong>
            </p>
            ...
            <p>
              <strong>Профілактика:</strong> карантин, гігієна, уникати контакту
              з дикими кроликами.
            </p>
          </div>
        </article>
        ...
        <article className="parasites-card">
          ...
          <div className="parasites-card-body">
            <div className="parasites-chips">
              <span className="parasites-chip danger">Заразна для людини</span>
              <span className="parasites-chip ok">Лікується</span>
            </div>
            <p>
            ...
            <ul>
              <li>
                ...
                традиційно наносили на уражені ділянки, змазує шкіру та утруднює
                дихання кліщам
              </li>
              <li>
            ...
            <div className="parasites-alert danger">
              ...
              звернутися до дерматолога. Дьоготь — допоміжний засіб, коросту він
              сам по собі не виліковує, потрібен акарицидний препарат.
            </div>
            <p>
      ...
      <div className="parasites-grid">
        <article className="parasites-card">
          ...
          <div className="parasites-card-body">
            ...
            <ul>
              <li>
                <strong>Фенбендазол (Panacur)</strong> — 20 мг/кг раз на день 5
                днів або 50 мг/кг одноразово
              </li>
              <li>
              ...
              <li>
                <strong>Гідро+Лев</strong> (левамізолу гідрохлорид) — 1 г
                порошку на 1 л питної води, орально, протягом 3 діб
              </li>
            ...
            <div className="parasites-alert warn">
              ⚠️ Гідро+Лев не застосовувати самкам в останній третині вагітності
              та виснаженим тваринам. Не поєднувати з фосфорорганічними
              препаратами, пірантелом, морантелом, неостигміном.
            </div>
            <p>
              <strong>Профілактика:</strong> дегельмінтизація двічі на рік
              (навесні та восени), чистота, уникати контакту з ґрунтом де ходять
              дикі тварини.
            </p>
          </div>
        </article>
        ...
        <article className="parasites-card">
          ...
          <div className="parasites-card-body">
            ...
            <p>
              ...
              Найнебезпечніші: E. stiedae (печінкова форма), E. intestinalis та
              E. flavescens (кишкова форма).
            </p>
            <p>
            ...
            <div className="parasites-alert danger">
              ...
              кокцидіостатик. Через високу швидкість загибелі молодняку затримка
              з препаратом заради народних методів небезпечна для поголів'я.
            </div>
            <p>
