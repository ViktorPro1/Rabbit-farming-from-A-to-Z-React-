  ...
  return (
    <main className="newfood-page">
      ...
      <div className="newfood-wrap">
        ...
        {/* ── ЧОМУ КРОЛЬ ТАКИЙ ЧУТЛИВИЙ ── */}
        <h2 className="newfood-section-title">
          Чому кроль такий чутливий до зміни корму
        </h2>
        ...
        <div className="newfood-cards-grid">
          ...
          <div className="newfood-card">
            <div className="newfood-card-header">
              <span>🚫</span>
              <span>Кроль не може блювати</span>
            </div>
            <p>
        ...
        <div className="newfood-calc">
          ...
          <div className="newfood-alert ok">
            💡 Якщо в будь-який день помітили рідкий послід або кроль
        ...
        <div className="newfood-cards-grid">
          <div className="newfood-card danger">
            ...
            <p>
              Кроль не їсть більше 12 годин. Здутий і твердий живіт. Рідкий або
          ...
          <div className="newfood-card warning">
            ...
            <p>
              ...
              звичний розмір. Кроль їсть менше або вибирає тільки старий корм.
          ...
          <div className="newfood-card ok">
            ...
            <p>
              Послід округлий, рівномірний, помірно твердий. Кроль їсть обидва
