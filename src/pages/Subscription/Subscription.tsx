...
const features = [
  ...
  },
  {
    icon: "💊",
    title: "Пропойка",
    desc: "Облік антибіотиків та дегельмінтизації по клітках. Вказуєш препарат, дату — система нагадує коли потрібен наступний прийом.",
    details: [
      "Будь-який препарат та дозування",
      "Дата прийому та наступного курсу",
      "Підсвічування прострочених прийомів",
      "Нагадування за 14 днів",
    ],
  },
  {
    icon: "🧴",
