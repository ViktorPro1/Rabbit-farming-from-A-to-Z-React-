...
const features = [
  ...
  },
  {
    icon: "🏷️",
    title: "Собівартість",
    desc: "Аналіз собівартості вирощування. Система сама об'єднує дані з Фінансів, Відгодівлі та Зважування і показує, скільки коштує партія кролів та один кілограм ваги, без повторного введення.",
    details: [
      "Витрати на корм, препарати та вакцинацію по кожній партії",
      "Собівартість одного кроля та 1 кг ваги",
      "Окремий розрахунок для кожного кроля з реєстру",
      "Таблиця розподілу витрат між відгодівлею та реєстром",
    ],
  },
  {
    icon: "📉",
        ...
        <div className="sub-hero">
          ...
          <div className="sub-hero-stats">
            <div className="sub-stat">
              <span className="sub-stat-num">22</span>
        ...
        <div className="sub-trial-block">
          ...
          <div className="sub-trial-content">
            ...
            <p>
              ...
              надамо тестовий доступ, щоб Ви оцінили систему перед оплатою.
            </p>
          </div>
        </div>
        ...
        <div className="sub-faq">
          <div className="sub-faq-item">
            ...
            <p>
              ...
              на телефон як PWA та як TWA (без App Store).
            </p>
          </div>
          <div className="sub-faq-item">
