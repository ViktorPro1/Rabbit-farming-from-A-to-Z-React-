...
export default function AccessGuard({ children }: Props) {
  ...
  if (status === "expired") {
    return (
      ...
      >
        <h2>⏳ Пробний період закінчився</h2>
        <p>
          Термін доступу до вашого кабінету вийшов. Щоб продовжити користуватись
          обліком кроликів та калькулятором, оформіть підписку.
        </p>
        <p>
