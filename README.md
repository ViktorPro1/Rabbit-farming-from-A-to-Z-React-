...
- Фінансовий облік (доходи/витрати, прибуток по місяцях)
...
- SEO-оптимізація
- Швидка навігація
- Збільшення розміру шрифту для зручнішого читання
...
Розмір шрифту платформи частіше налаштовують читачі старшого віку — за
статистикою дописів понад 75% авдиторії 50+.

Реалізовано:

- Кнопка "Aa" в шапці платформи перемикає три рівні масштабу тексту
- Вибір зберігається між візитами (localStorage)
- Масштабування діє на весь сайт, без винятків для окремих сторінок

---

## 💰 Фінанси

Облік доходів і витрат господарства в одному місці — без ручного підрахунку в зошиті чи Excel.

Реалізовано:

- Автоматичний облік доходу з продажів (розділ «Відгодівля»)
- Витрати вручну по категоріях: корм, ветеринарія, обладнання, транспорт, інше
- Огляд по місяцях у вигляді графіка «дохід / витрати»
- Розрахунок прибутку — за кожен місяць і загалом
- Вкладки: Огляд, Витрати, Доходи
